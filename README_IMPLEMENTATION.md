...
If you face below error in git:
```
ERROR:
git push origin main
To https://github.com/ANIKHILT600/go-app-cicd.git
 ! [rejected]        main -> main (fetch first)
error: failed to push some refs to 'https://github.com/ANIKHILT600/go-app-cicd.git'
...
```
This is happening due to gir Run_id updates in value.yaml file in remote. Then use below git pull with rebase command:
``
git pull origin main --rebase
```

Finally check and push your changes:
```
git push origin main
```